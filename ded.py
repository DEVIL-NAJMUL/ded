...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/DEVIL-NAJMUL/ded/blob/main/approval.txt"])
...
a=requests.get("https://github.com/DEVIL-NAJMUL/ded/blob/main/approval.txt").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
